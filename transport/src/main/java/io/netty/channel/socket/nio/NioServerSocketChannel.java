...
public class NioServerSocketChannel extends AbstractNioMessageChannel
    ...
    private static ServerSocketChannel newChannel(SelectorProvider provider, InternetProtocolFamily family) {
        try {
//          创建ServerSocketChannel ipv4 or ipv6
...
//      赋值OP_ACCEPT事件,设置channel非阻塞
        super(null, channel, SelectionKey.OP_ACCEPT);
//      包装为NioServerSocketChannelConfig javaChannel即ServerSocketChannel
...
//  通过查找查询底层套接字来查看它是否已连接来工作  isOpen - channel是否打开
    @Override
...
//            javaChannel（）获取NIO原生channel，并绑定地址&端口
