...
public class NioEventLoopGroup extends MultithreadEventLoopGroup {
    ...
    /**
     * 初始化nioEventLoopGroup 数组
     * 是EventLoop池
     * EventLoop:
     * 1. 每个EventLoop 对应一个线程，对应多个channel
     * 2. 每个EventLoop 是一个Executor
...
//        JVM中惟一的provider() SelectorProvider.provider().openSelector()=selector.open()
//        SelectorProvider.provider().openServerSocketChannel()=ServerSocketChannel.open()
...
//        设置一个默认工厂策略
    ...
    public NioEventLoopGroup(int nThreads, Executor executor, final SelectorProvider selectorProvider,
        ...
        // 向SingleThreadEventExecutor添加任务失败时，执行的拒绝逻辑,返回RejectedExecutionException异常
