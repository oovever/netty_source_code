...
//        校验 channel group channelFactory不能为空
        validate();
        return doResolveAndConnect(remoteAddress, config.localAddress());
    }
...
//                    localAddress 设置后 bind无惨构造方法可以不绑定参数
//                    解析成功立刻连接
...
//              设置监听器，连接发生异常则关闭channel
    ...
    /**
     * 获取channel 的pipeline，并设置handler以及option attr参数
     */
    @Override
